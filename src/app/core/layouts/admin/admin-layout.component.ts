...
export class AdminLayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private router: Router, zone: NgZone) {
    ...
    // to update options from floating config component (disabled for now)
    ...
    isOver(): boolean {
        if (0){
            //this.url.match('/admin/brandsite/contents/section/(\\d)') ) {
            return true; // for routes needing full screen
        } else {
