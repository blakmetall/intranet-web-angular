...
export class AddressService {
    ...
    all(req){
        ...
        let requestUrl = environment.api_url + 'addresses/all';
    ...
    add(address){
        let requestUrl = environment.api_url + 'addresses/store';
    ...
    edit(address){
        let requestUrl = environment.api_url + 'addresses/update/' + address.id;
        return this.http.post(requestUrl, address).map( (res: any) => {
            return res;
        });
    }
    ...
    get(id){
        let requestUrl = environment.api_url + 'addresses/get/' + id;
        return this.http.get(requestUrl).map( (res: any) => {
            return res;
        });
    }
    ...
    restore(id){
        let requestUrl = environment.api_url + 'addresses/restore/' + id;
        return this.http.get(requestUrl).map( (res: any) => {
            return res;
        });
    }
    ...
    delete(id, forceDelete){
        let requestUrl = environment.api_url + 'addresses/delete/' + id;
        if(forceDelete){
