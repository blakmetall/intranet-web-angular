...
import {ExensionRequestsDatabase, ExensionRequest} from './exension-requests.database';
...
export class ExensionRequestsDataSource extends DataSource<any> {

    constructor(
        private _db: ExensionRequestsDatabase,
    ...
    connect(): Observable<ExensionRequest[]> {
        //filter event
