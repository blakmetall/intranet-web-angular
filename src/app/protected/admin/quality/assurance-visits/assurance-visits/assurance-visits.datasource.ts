...
import {AssuranceVisitsDatabase, AssuranceVisit} from './assurance-visits.database';
...
export class VisitsDatasource extends DataSource<any> {

    constructor(
        private _db: AssuranceVisitsDatabase,
