...
import {PermissionsGroupsDatabase, PermissionGroupData} from './permissions-groups.database';
...
export class PermissionsGroupsDataSource extends DataSource<any> {

    constructor(
        private _db: PermissionsGroupsDatabase,
    ...
    connect(): Observable<PermissionGroupData[]> {
        //filter event
