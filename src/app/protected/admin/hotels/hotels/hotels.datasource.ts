...
import {HotelsDatabase, HotelData} from './hotels.database';
...
export class HotelsDataSource extends DataSource<any> {

    constructor(
        private _db: HotelsDatabase,
