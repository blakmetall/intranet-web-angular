...
import {BrandsiteSectionsDatabase, SectionsData} from './sections.database';
...
export class SectionsDataSource extends DataSource<any> {

    constructor(
        private _db: BrandsiteSectionsDatabase,
    ...
    connect(): Observable<SectionsData[]> {
        //filter event
