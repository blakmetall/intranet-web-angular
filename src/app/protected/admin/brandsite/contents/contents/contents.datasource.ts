...
import {BrandsiteContentsDatabase, BrandsiteContentData} from './contents.database';
...
export class BrandsiteContentsDataSource extends DataSource<any> {

    constructor(
        private _db: BrandsiteContentsDatabase,
    ...
    connect(): Observable<BrandsiteContentData[]> {
        //filter event
