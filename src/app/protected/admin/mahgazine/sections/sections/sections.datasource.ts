...
import {MahgazineSectionsDatabase, MahgazineSectionData} from './sections.database';
...
export class MahgazineSectionsDataSource extends DataSource<any> {

    constructor(
        private _db: MahgazineSectionsDatabase,
    ...
    connect(): Observable<MahgazineSectionData[]> {
        //filter event
