...
import {MahgazineEditionsDatabase, MahgazineEditionData} from './editions.database';
...
export class MahgazineEditionsDataSource extends DataSource<any> {

    constructor(
        private _db: MahgazineEditionsDatabase,
    ...
    connect(): Observable<MahgazineEditionData[]> {
        //filter event
