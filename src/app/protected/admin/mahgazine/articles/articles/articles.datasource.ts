...
import {MahgazineArticlesDatabase, MahgazineArticleData} from './articles.database';
...
export class MahgazineArticlesDataSource extends DataSource<any> {

    constructor(
        private _db: MahgazineArticlesDatabase,
    ...
    connect(): Observable<MahgazineArticleData[]> {
        //filter event
