...
import {TasksArchiveDatabase, TaskArchiveData} from './archive.database';
...
export class TasksArchiveDataSource extends DataSource<any> {

    constructor(
        private _db: TasksArchiveDatabase,
    ...
    connect(): Observable<TaskArchiveData[]> {
        //filter event
