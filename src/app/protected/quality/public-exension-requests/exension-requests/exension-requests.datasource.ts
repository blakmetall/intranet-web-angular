...
import {PublicExensionRequestDatabase, PublicExensionRequest} from "./exension-requests.database";
...
export class PublicExensionRequestDatasource extends DataSource<any> {

    constructor(
        private _db: PublicExensionRequestDatabase,
    ...
    connect(): Observable<PublicExensionRequest[]> {
        //filter event
