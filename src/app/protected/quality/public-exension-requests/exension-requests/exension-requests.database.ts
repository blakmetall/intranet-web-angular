...
export interface PublicExensionRequest {
    id: string;
    hotel:string;
    owner:any;
    is_approved: string;
...
@Injectable()
export class PublicExensionRequestDatabase {
    dataChange: BehaviorSubject<PublicExensionRequest[]> = new BehaviorSubject<PublicExensionRequest[]>([]);

    get data(): PublicExensionRequest[] {
