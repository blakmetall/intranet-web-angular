...
import {ExtensionRequestsDatabase, PublicExtensionVisit} from './extension-requests.database';
...
export class ExtensionRequestsDatasource extends DataSource<any> {

    constructor(
        private _db: ExtensionRequestsDatabase,
    ...
    connect(): Observable<PublicExtensionVisit[]> {
        //filter event
