...
import {EventsCategoriesDatabase, EventCategoryData} from "./categories.database";
...
export class EventsCategoriesDataSource extends DataSource<any> {

    constructor(
        private _db: EventsCategoriesDatabase,
    ...
    connect(): Observable<EventCategoryData[]> {
        //filter event
